...
INSERT INTO clients (name, id_document_number)
VALUES
    ("Manolo Rodrigo", "12345678D"),
    ("Manuel Pepe", "87654321C"),
    ("Paco de las Cuevas", "54326754C"),
    ("Carmelo Felipe", "05924DF452");

INSERT INTO insurances (client_id, percentage_covered, start_date, end_date,annual_cost, type)
VALUES
    ...
    (2, 18, "2021-01-01", "2024-01-01", 750.34, "VEHICLE"),
    (3, 10, "2020-02-01", "2021-02-01", 59.43, "VEHICLE");

INSERT INTO vehicles (insurance_id, plate_number, price)
VALUES
    (2, "1234BCD", 8000),
    (3, "4321BCD", 4000),
    (6, "4356CDB", 3000),
...
INSERT INTO properties (insurance_id, area, city, street, number, unit)
VALUES
